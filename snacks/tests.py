...
class SnackTests(TestCase):
    ...
    def test_snack_content(self):
        ...
        self.assertEqual(f"{self.snack.purchaser}",'a@gmal.com')
    ...
    def test_snack_create_view(self):
        ...
        self.assertRedirects(response,reverse('snack/snack_detail',args='2'))
    ...
    def test_snack_update_view_redirect(self):
        response = self.client.post(
            ...
            {"name": "pepsi","purchaser":self.user.id,"description":"anythin"}
        )
